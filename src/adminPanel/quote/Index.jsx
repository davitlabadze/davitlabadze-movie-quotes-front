                  ...
                  <td className='w-1/4 p-4 px-6 text-center '>
                    <Link to={`/adminpanel/quotes/${quote.id}/edit`}>
                      <button className='ml-4'>
                        <PencilIcon className='w-6 h-6 text-slate-300 dark:text-slate-700 hover:dark:text-slate-500' />
                      </button>
                    </Link>
                    <button
                      ...
                      className='ml-2'
                    >
                      <TrashIcon className='w-6 h-6 text-slate-300 dark:text-slate-700 hover:dark:text-slate-500' />
                    </button>
                  </td>
                </tr>
              ))}
